...
// Read-only auditor: can view everything across all sites, but cannot create or edit.
export const auditorRole = (r) => r === "auditor";

// Can this role create/edit/submit? Everyone except the read-only auditor.
export const canEdit = (r) => r !== "auditor";

// This is a dedicated Food Safety app — every signed-in user has FS access (view).
